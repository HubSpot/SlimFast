...
public class UploadFromManifestMojo extends AbstractMojo {
  ...
  @Parameter(
    property = "slimfast.fromManifestFileUploader",
    alias = "fileUploader",
  ...
  public void execute() throws MojoExecutionException, MojoFailureException {
    ...
    try {
      preparedArtifactWrapper =
        JsonHelper.readPreparedArtifactsFromJson(Paths.get(manifestFile).toFile());
    } catch (IOException e) {
  ...
  private FromManifestUploader instantiateFileUploader() throws MojoExecutionException {
    ...
    try {
      ...
      throw new MojoExecutionException(
        "Must implement FromManifestUploader interface",
        e
      );
    }
  }
